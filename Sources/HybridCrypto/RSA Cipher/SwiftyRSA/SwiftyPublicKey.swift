...
public class SwiftyPublicKey: SwiftyKey {
    ...
    public static func publicKeys(pemEncoded pemString: String) -> [SwiftyPublicKey] {
        ...
        let keys = matches.compactMap { result -> SwiftyPublicKey? in
            ...
            return try? SwiftyPublicKey(pemEncoded: String(thisKey))
        }
