...
@objc(PublicKey)
public class _objc_PublicKey: NSObject, SwiftyKey, ObjcBridgeable { // swiftlint:disable:this type_name
    
    fileprivate let swiftValue: SwiftyPublicKey
    ...
    required public init(swiftValue: SwiftyPublicKey) {
        self.swiftValue = swiftValue
    }
    
    @objc required public init(data: Data) throws {
        self.swiftValue = try SwiftyPublicKey(data: data)
    }
    
    @objc public required init(reference: SecKey) throws {
        self.swiftValue = try SwiftyPublicKey(reference: reference)
    }
    
    @objc public required init(base64Encoded base64String: String) throws {
        self.swiftValue = try SwiftyPublicKey(base64Encoded: base64String)
    }
    
    @objc public required init(pemEncoded pemString: String) throws {
        self.swiftValue = try SwiftyPublicKey(pemEncoded: pemString)
    }
    
    @objc public required init(pemNamed pemName: String, in bundle: Bundle) throws {
        self.swiftValue = try SwiftyPublicKey(pemNamed: pemName, in: bundle)
    }
    
    @objc public required init(derNamed derName: String, in bundle: Bundle) throws {
        self.swiftValue = try SwiftyPublicKey(derNamed: derName, in: bundle)
    }
    
    @objc public static func publicKeys(pemEncoded pemString: String) -> [_objc_PublicKey] {
        return SwiftyPublicKey.publicKeys(pemEncoded: pemString).map { _objc_PublicKey(swiftValue: $0) }
    }
}
...
@objc(PrivateKey)
public class _objc_PrivateKey: NSObject, SwiftyKey, ObjcBridgeable { // swiftlint:disable:this type_name
...
public class _objc_ClearMessage: NSObject, Message, ObjcBridgeable { // swiftlint:disable:this type_name
    ...
    @objc public func encrypted(with key: _objc_PublicKey, padding: SwiftyPadding) throws -> _objc_EncryptedMessage {
...
public class _objc_EncryptedMessage: NSObject, Message, ObjcBridgeable { // swiftlint:disable:this type_name
    ...
    @objc public func decrypted(with key: _objc_PrivateKey, padding: SwiftyPadding) throws -> _objc_ClearMessage {
